...
class ResistanceScreenR2 extends StatefulWidget {
  @override
  _ResistanceScreenR2State createState() => _ResistanceScreenR2State();
}

class _ResistanceScreenR2State extends State<ResistanceScreenR2> {
  String resistanceR2 = '';
  ...
  channelconnect() {
    try {
      ...
      channel.sink.add("range2000");
      channel.stream.listen((message) {
        print(message);
        setState(() {
          resistanceR2 = message;
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
                ...
                onPressed: () {
                  origin.resistanceR2 = resistanceR2Display;
                }),
            ElevatedButton(
                child: Text("Done"),
                style: ElevatedButton.styleFrom(
